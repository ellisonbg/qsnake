...
def broyden2(F, xin, iter=10, alpha=0.4):
    ...
    for n in range(iter):
        ...
        print "%d:  |F(x)|=%.8f"%(n+1, norm(Fxm))
    return xm.flat

def broyden3(F, xin, iter=10, alpha=0.4):
    """Broyden's second method.
...
def broyden_generalized(F, xin, iter=10, alpha=0.1, M=5):
...
def anderson(F, xin, iter=10, alpha=0.1, M=5, w0=0.01):
...
def anderson2(F, xin, iter=10, alpha=0.1, M=5, w0=0.01):
    """Anderson method.
...
def broyden_modified(F, xin, iter=10, alpha=0.35, w0=0.01, wl=5):
...
def broyden1(F, xin, iter=10, alpha=0.1):
...
def broyden1_modified(F, xin, iter=10, alpha=0.1):
...
def vackar(F, xin, iter=10, alpha=0.1):
    """J=diag(d1,d2,...,dN)
...
def linearmixing(F,xin, iter=10, alpha=0.1):
    """J=-1/alpha
...
def excitingmixing(F,xin,iter=10,alpha=0.1,alphamax=1.0):
    """J=-1/alpha
